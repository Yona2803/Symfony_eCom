 ...
 */
final class Version20250207120605 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password LONGTEXT NOT NULL, username VARCHAR(25) NOT NULL, phone_number VARCHAR(10) DEFAULT NULL, first_name VARCHAR(30) NOT NULL, last_name VARCHAR(30) DEFAULT NULL, address VARCHAR(60) DEFAULT NULL, google_id VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
